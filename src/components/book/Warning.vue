<template>
  <page>
    ...
    Aprender programação funcional, Clojure, ou qualquer outra forma de <i>LISP</i>, pode mudar definitivamente a forma como você enxerga o desenvolvimento de software.
    </p>
