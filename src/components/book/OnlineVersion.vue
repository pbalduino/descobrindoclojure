    ...
    <div class="container">
      <div class="row">
        <div class="col-sm text-clojure-dark-blue">
          ...
          <p class="text-justify">
          Para sugestões ou correções, utilize o sistema de <i>issues</i> em <a href="https://github.com/pbalduino/descobrindoclojure">https://github.com/pbalduino/descobrindoclojure</a>
          </p>
          <p class="text-justify">
          Aproveite.
          </p>
